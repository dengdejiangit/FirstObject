...
import com.example.administrator.testproject.greendao.gen.DaoSession;
...
public class DaoDbHelper {
    ...
    private DaoDbHelper(){
        //封装数据库的创建、更新、删除
        DaoMaster.DevOpenHelper openHelper = new MyOpenHelper(XApplication.getContext(),DB_NAME,null);
        //获取数据库
