...
import com.example.administrator.testproject.code.home.other.StepCount;
import com.example.administrator.testproject.code.home.other.StepValuePassListener;
...
public class BindService extends Service implements SensorEventListener {
    ...
    private void startStepDetector() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && sensorManager != null) {
            //SDK版本大于等于19开启计步传感器
